...
$(function(e){
	storyObj.say({role: '', content: '因为能够与她相遇而雀跃不已。'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '', content: '也因为随之而来的分别而遗憾不已。'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '', content: '但那时的我却未意识到……'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '', content: '站在试验台前，看着那个人逐渐睁开的双眼。'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '', content: '早已消失的记忆也随之涌现出来。'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '', content: '不仅是很久之前消失的记忆，就连跟她最初的记忆也依依浮现。'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '', content: '此刻的我才意识到——'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '', content: '她比我更加的难过，她的悲伤远远超出了我的想象。'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '', content: '第一次的相遇，最后一次的离别。'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '?', content: '能够再次遇见你……'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '?', content: '但正因为如此……'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: ' ', content: '脑海里渐渐的感觉有些僵硬，不断闪回的记忆，只剩下几个模糊的碎片，以及几句断断续续的话语。'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	storyObj.say({role: '?', content: '请忘掉我吧……'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
...
$(function(e){
	...
	storyObj.say({role: ' ', content: '黑色将我的视线带走。'});
});
$(function(e){
	storyObj.waitDialogAndClick(e);
});
